...
if __name__ == '__main__':
    ...
    plant_protein_db = lib_dir + '/alluniRefprexp082813'
    ...
    output_table = clean_internal_seq + '.domain'
    temp_dir = tmp_output_dir + '/domain'
    get_domain_info(internal_seq_filter, plant_protein_db, output_table, threads, temp_dir)
    purge_internal_seq_by_table(internal_seq_filter, plant_protein_db, clean_internal_seq, output_table)
    internal_seq_filter = clean_internal_seq
