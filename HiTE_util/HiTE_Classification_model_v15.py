...
# 去掉了数据中的-LTR和-I序列，这部分表示不完整的LTR
# 将序列切分成Internal_seq, LTR, TIR，加入TSD_len和TSD_seq, 加入domain结果,加入终端5bp：
# k=1,2,3,4. kernel_size: 3, 4*Conv1
# Accuracy: 0.9505457485514082
# Precision: 0.9241058718963585
# Recall: 0.8572823957044893
# F1: 0.8830136389144
...
from keras.layers import Layer, Input, Dense, Dropout, Activation, Flatten, LSTM, Conv1D, Conv2D, MaxPooling1D, MaxPooling2D, Bidirectional
