...
X_feature_len = max_TE_len + 11 * 4

X, Y, seq_names = load_repbase_with_TSD(repbase_train)
#X -> {seq_name: [0, 4, 2, 3,...], }
X = generate_mats(X, seq_names, kmer_size, base_num, max_TE_len, threads)
#print(X)
print(X.shape)
...
X_test = generate_mats(X_test, seq_names, kmer_size, base_num, max_TE_len, threads)
