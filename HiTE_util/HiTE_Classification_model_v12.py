...
# 使用三个CNN模型进行连接，第一个模型用于处理Seq, LTR, TIR序列的k-mer特征，维度是4^k；
# 第二个模型用于处理TSD seq, TSD_len和Domain特征，维度是11*4+1+29;

# 序列不进行切分结果：
# k=1,2,3,4. kernel_size: 3, 4*Conv1
# Accuracy: 0.7871260683760684
# Precision: 0.8822191041710227
# Recall: 0.6269731893363168
# F1: 0.6840270836399606

# 将序列切分成Internal_seq, LTR, TIR结果：
# k=1,2,3,4. kernel_size: 3, 4*Conv1
# Accuracy: 0.8595085470085471
# Precision: 0.9084899816929469
# Recall: 0.6963522069439065
# F1: 0.7473099433985171

# 将序列切分成Internal_seq, LTR, TIR，加入TSD_len和TSD_seq结果：
# k=1,2,3,4. kernel_size: 3, 4*Conv1
# Accuracy: 0.8748664529914529
# Precision: 0.9077357204794247
# Recall: 0.7104020957045808
# F1: 0.7550247531270576

# 将序列切分成Internal_seq, LTR, TIR，加入TSD_len和TSD_seq, 加入domain结果：
# k=1,2,3,4. kernel_size: 3, 4*Conv1
# Accuracy: 0.9471153846153846
# Precision: 0.9214796144292373
# Recall: 0.8471964291628323
# F1: 0.8738243965009355
