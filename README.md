...
在[demo](/demo)目录下，我们提供了HiTE, EDTA, RepeatModeler2的真实TE libraries，你可以按照下面的指示尝试使用NeuralTE对它们进行分类。
...
All experimental results in the manuscript of NeuralTE can be reproduced step by step.
